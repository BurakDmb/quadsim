...
def evalSolutionHist(self_obj, env, num_episode, t_end, control_freq):
    ...
    self_obj.assertGreaterEqual(env.high[0],
                                np.float32(max(abs(sol_x[0, :].max()),
                                               abs(sol_x[0, :].min()))))
    self_obj.assertGreaterEqual(env.high[1],
                                np.float32(max(abs(sol_x[1, :].max()),
                                               abs(sol_x[1, :].min()))))
    self_obj.assertGreaterEqual(env.high[2],
                                np.float32(max(abs(sol_x[2, :].max()),
                                               abs(sol_x[2, :].min()))))
    self_obj.assertGreaterEqual(env.high[3],
                                np.float32(max(abs(sol_x[3, :].max()),
                                               abs(sol_x[3, :].min()))))
    self_obj.assertGreaterEqual(env.high[4],
                                np.float32(max(abs(sol_x[4, :].max()),
                                               abs(sol_x[4, :].min()))))
    self_obj.assertGreaterEqual(env.high[5],
